    ...
    <div className="min-h-screen bg-[#151230] text-gray-200">
      ...
      <div className="bg-[#1e1c3a]/80 backdrop-blur-xl border-b border-white/10 py-6 relative overflow-hidden">
        ...
        <div className="container-custom relative z-10">
          <Link to="/products" className="inline-flex items-center gap-2 text-sm text-violet-400 hover:text-violet-300 hover:gap-3 transition-all mb-3 font-semibold">
            <FiArrowLeft size={16} /> Continue Shopping
          </Link>
          <h1 className="text-3xl sm:text-4xl font-black text-white tracking-tight mb-2">Shopping Cart</h1>
          <p className="text-xs text-gray-400 font-medium">{cartCount} premium item{cartCount !== 1 ? 's' : ''} reserved</p>
        </div>
      </div>
