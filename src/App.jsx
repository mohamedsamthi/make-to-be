    ...
    <AuthProvider>
      <CartProvider>
        ...
        <Router>
          ...
          <main className="min-h-screen pt-14 md:pt-[104px]">
            <Routes>
              {/* Customer Routes */}
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="fixed bottom-6 right-6 z-50 w-14 h-14 rounded-2xl bg-green-500 text-white flex items-center justify-center shadow-2xl shadow-green-500/30 hover:bg-green-600 hover:scale-110 transition-all group"
            ...
            >
              ...
              <span className="absolute -top-8 right-0 bg-[var(--color-surface-card)] text-xs px-3 py-1.5 rounded-lg opacity-0 group-hover:opacity-100 transition-all whitespace-nowrap border border-[var(--color-border)] shadow-lg">
                Chat with us
              </span>
            </a>
          </div>
