...
const WhatsAppButton = () => {
  ...
  return (
    <a
      ...
      target="_blank"
      rel="noreferrer"
      className="group fixed bottom-6 right-6 z-50 flex h-14 w-14 items-center justify-center rounded-2xl bg-white text-black shadow-2xl shadow-white/10 transition-all hover:scale-110 hover:bg-gray-100"
